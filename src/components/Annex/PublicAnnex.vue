        ...
        <el-row :gutter="24">
          <el-col :span="22">
            <el-form-item label="附件">
              <Upload v-model="temp.attachment_id" :id="annexData.id" :value="temp.attachment_id" :type="'CustomerOrder'"/>
            </el-form-item>
          </el-col>
...
export default {
  ...
  methods: {
    ...
    createAnnex() {
      ...
      // }
      // let temp1 = {
      //   attachment_entity_type: this.type || '',
      //   attachment_entity_id: this.id || '',
      //   path: file.name,
      //   name: file.name,
